...
public class HighScoreManager : SingletonMonobehaviour<HighScoreManager>
{
    ...
    private void LoadScores()
    {
        ...
        if (File.Exists(Application.persistentDataPath + "/DungeonRunnerHighScores.dat"))
        {
            ClearScoreList();

            FileStream file = File.OpenRead(Application.persistentDataPath + "/DungeonRunnerHighScores.dat");
    ...
    private void SaveScores()
    {
        ...
        FileStream file = File.Create(Application.persistentDataPath + "/DungeonRunnerHighScores.dat");
