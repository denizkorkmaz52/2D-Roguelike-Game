...
public static class Settings
{
    ...
    public const float useAimAngleDistance = 3.5f;// if the target distance is less than this ten the aim angle will be used(calculated from player), else the weapon aim angle
