...
public static class AStar
{
    ...
    private static int GetDistance(Node nodeA, Node nodeB)
    {
        ...
        if (dstX > dstY)
            return 14 * dstY + 10 * (dstX - dstY); // 10 used instead of using 1, 14 is a pythagoras approximation SQRT(10*10 + 10*10) - to avoid using floats
        ...
        InstantiatedRoom instantiatedRoom)
    {
        ...
        //if neighbour is an obstacle or it is in the closed list then skip
