...
public class ReloadWeapon : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        setActiveWeaponEvent.OnSetActiveWeapon += SetActiveWeaponEvent_OnSetActiveWeaponEvent;
    }
    ...
    private void SetActiveWeaponEvent_OnSetActiveWeaponEvent(SetActiveWeaponEvent setActiveWeaponEvent, SetActiveWeaponEventArgs setActiveWeaponEventArgs)
    {
