...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    #endregion
    #region Tooltip
    [Tooltip("Sprite to be used for ammo")]
    #endregion
    public Sprite ammoSprite;
    #region Tooltip
    [Tooltip("Populate with the prefab to be used for the ammo. If multiple prefabs are specified then a random prefab from the array will be selected07." +
    ...
    #endregion
    #region Tooltip
    [Tooltip("The scriptable object that defines the parameters for the ammo hit effect")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("Minimum speed of the ammo - the speed will be random value between the min and max")]
    #endregion
    public float ammoSpeedMin = 20f;
    #region Tooltip
    [Tooltip("Maximum speed of the ammo - the speed will be random value between the min and max")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("The rotation speed in degrees per second of the ammo")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("This is the minimum spread angle of the ammo. the higher spread means less accuracy. A random spread is calculated between the min and max values")]
    #endregion
    public float ammoSpreadMin = 0f;
    #region Tooltip
    [Tooltip("This is the maximum spread angle of the ammo. the higher spread means less accuracy. A random spread is calculated between the min and max values")]
    #endregion
    ...
    #endregion
    #region Tooltip"
    [Tooltip("This is the minimum number of ammo that are spawned per shot. A random number of ammo are spawned between the minimum and the maximum values")]
    #endregion
    public int ammoSpawnAmountMin = 1;
    #region Tooltip
    [Tooltip("This is the maximum number of ammo that are spawned per shot. A random number of ammo are spawned between the minimum and the maximum values")]
    #endregion
    public int ammoSpawnAmountMax = 1;
    #region Tooltip
    [Tooltip("Minimum spawn interval time. the time interval in seconds between spawned ammo is a random value between the minimum and maximum values")]
    #endregion
    public float ammoSpawnIntervalMin = 0f;
    #region Tooltip
    [Tooltip("Maximum spawn interval time. the time interval in seconds between spawned ammo is a random value between the minimum and maximum values")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("Selected if an ammo trails is required, otherwise deselect")]
    #endregion
